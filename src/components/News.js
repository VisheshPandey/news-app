...
export class News extends Component {
	...
	async updatePage(){
		const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=e8fbd2edeb434ec89fb529497098f997&pageSize=${this.props.pageSize}`;
